...
load_touch_drivers() { 
	cp /tmp/vendor/lib/modules/focal_touch.ko /lib/modules
        cp /tmp/vendor/lib/modules/goodix_brl_touch.ko /lib/modules
        cp /tmp/vendor/lib/modules/goog_touch_interface.ko /lib/modules
        local path1=/lib/modules;
	local path2=/vendor/lib/modules;
	local modules="focal_touch.ko goodix_brl_touch.ko goog_touch_interface.ko";
